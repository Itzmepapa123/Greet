...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6408414806:AAFx7eAbZN-_MUYYzWFTqutHKCNLwoLsWiA")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002102984286"))
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://itzmeproman:itzmeproman@itzmeproman.bg8wsm2.mongodb.net/?retryWrites=true&w=majority&appName=itzmeproman")
...
try:
    ADMINS=[7030439873]
    for x in (os.environ.get("ADMINS", "5984035173 7268039061 7268039061 5984035173 6666868150 6565476720 6258381233 6360741702").split()):
        ADMINS.append(int(x))
except ValueError:
